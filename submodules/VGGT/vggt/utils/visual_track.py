...
def visualize_tracks_on_images(
    ...
    frames_per_row=3,  # New parameter for grid layout
    ...
    for s in range(S):
        ...
        # frame_path = os.path.join(out_dir, f"{save_name}_{s:04d}.png")
    ...
    if save_grid:
        ...
        for row in range(num_rows):
            ...
            row_img = frame_images[start_idx:end_idx]
            row_img[1], row_img[0] = row_img[0], row_img[1]
        ...
        out_path = os.path.join(out_dir, f"{save_name}_tracks_grid.png")
